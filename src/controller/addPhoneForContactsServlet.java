...
/**
 * Servlet implementation class addPhoneForContactsServlet
 */
@WebServlet("/addPhoneForContactsServlet")
public class addPhoneForContactsServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public addPhoneForContactsServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		getServletContext().getRequestDispatcher("/new-phone.jsp").forward(request, response);
